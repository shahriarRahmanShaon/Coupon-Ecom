...
extension Cloth {
    ...
    static func all() -> [Cloth] {
        return [
            Cloth(name: "Printed Long Top", description: "Red floral print long top, has a round collar, full sleeves and available in different sizes for women.", imageURL: "kidsDress", price: 2399, company: "Rain & Rainbow", rating: 4, type: "sale", isFavorite: false, color: "Red", size: "S", discount: 40),
            ...
            Cloth(name: "Black Fit Top", description: "Black coloured self design woven fit and flare top has round neck and half sleeves.", imageURL: "overcoat", price: 2799, company: "Kook N Keen Garfield", rating: 3, type: "sale", isFavorite: false, color: "Black", size: "L", discount: 45),
            Cloth(name: "Longline Over Coat", description: "Gray longline over coat, has a notched lapel collar, button closure, long sleeves.", imageURL: "blackTop", price: 5149, company: "Chemistry Edition", rating: 4, type: "sale", isFavorite: true, color: "Gray", size: "L", discount: 30),
